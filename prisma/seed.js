...
const PRODUCTS = [
  ...
  // Kits novos (avaliação/carrossel de imagens)
  ["pv-reidosares", "KIT REI DOS ARES", 15.00, "pvp"],
  ["pv-raidbase", "KIT RAID BASE", 5.00, "pvp"],
  ["pv-reiend", "KIT REI END", 20.00, "pvp"],
  ["pv-reidomar", "KIT REI DO MAR", 20.00, "pvp"],
  ["pv-reinether", "KIT REI NETHER", 23.00, "pvp"],
  ["pv-minerador", "KIT MINERADOR", 5.00, "pvp"],
  ["pv-infernal", "KIT INFERNAL", 10.00, "pvp"],
  ["pv-end", "KIT END", 8.00, "pvp"],
  ["pv-redstone", "KIT RESDSTONE", 4.00, "pvp"],
  ["pv-armo", "KIT ARMO", 35.00, "pvp"],
  ["pv-cla", "KIT CLÃ", 30.00, "pvp"],
  ["pv-mestresmagia", "KIT MESTRES DA MAGIA", 8.00, "pvp"],
  ["pv-pvpdima", "KIT PVP DIMA", 5.00, "pvp"],
  ["pv-deus", "KIT DEUS", 12.00, "pvp"],
  // VIP
